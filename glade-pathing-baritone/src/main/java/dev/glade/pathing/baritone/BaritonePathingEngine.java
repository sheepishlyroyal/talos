...
import dev.glade.client.pathing.PathingUnavailableException;
 ...
 *
 * <p>Baritone is a separately installed, LGPL mod that is never bundled with Glade. There is no
...
public final class BaritonePathingEngine implements PathingEngine {
    ...
    public CompletableFuture<PathResult> goTo(Goal goal, PathingOptions options) {
        ...
        try {
            ...
            GladeClient.taskScheduler().addNonConflictingTask(
    ...
    private static final class PathMonitorTask extends GladeTask {
    ...
    private static final class Api {
        ...
        static {
            ...
            try {
                ...
                LOGGER.info("Baritone API not available; /glade goto will report it as not installed ({})",
                        absent.toString());
            }
            USABLE = ok;
        }
