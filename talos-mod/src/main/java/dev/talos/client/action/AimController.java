...
public final class AimController {
    ...
    public static void startTask(Minecraft client, float yaw, float pitch, long seed) {
        if (client.player == null) return;
        Vec3 target = client.player.getEyePosition().add(lookVector(yaw, pitch).scale(32.0));
