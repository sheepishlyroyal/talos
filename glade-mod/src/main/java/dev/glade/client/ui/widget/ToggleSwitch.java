...
public final class ToggleSwitch extends Widget {
    ...
    protected void renderWidget(DrawContext ctx, int mouseX, int mouseY, float deltaTicks) {
        ...
        GladeUi.roundedRect(ctx, x, y, width, height, height / 2.0f, trackColor);
        GladeUi.roundedRectBorder(ctx, x, y, width, height, height / 2.0f, 1.0f,
        ...
        GladeUi.roundedRect(ctx, knobX, y + KNOB_INSET, knobDiameter, knobDiameter, knobDiameter / 2.0f, palette.text());
    }
