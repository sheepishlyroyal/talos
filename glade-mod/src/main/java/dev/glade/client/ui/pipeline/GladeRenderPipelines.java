...
public final class GladeRenderPipelines {
    ...
    public static final RenderPipeline UI_ROUNDED_RECT = RenderPipeline.builder()
            .withLocation(Identifier.of("glade", "pipeline/ui_rounded_rect"))
            .withVertexShader(Identifier.of("glade", "core/ui_rounded_rect"))
            .withFragmentShader(Identifier.of("glade", "core/ui_rounded_rect"))
