package dev.glade.client.ui.draw;
...
/**
 * Reusable immediate-mode drawing facade for Glade's "liquid glass" UI toolkit.
 ...
 * {@link dev.glade.client.ui.pipeline.GladeRenderPipelines}) — nothing in this class
 * touches OpenGL or the render state directly.
 */
public final class GladeUi {
    private GladeUi() {
    }
